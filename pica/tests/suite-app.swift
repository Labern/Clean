...
let webRoot = cwd.appendingPathComponent("build/INT.:EXT..app/Contents/Resources/web").path.hasPrefix("/")
    ? cwd.appendingPathComponent("build/INT.:EXT..app/Contents/Resources/web")
    : cwd
let bundleWeb = FileManager.default.fileExists(atPath: webRoot.appendingPathComponent("index.html").path)
    ? webRoot
    : URL(fileURLWithPath: "/tmp/pica-build/INT.:EXT..app/Contents/Resources/web")
